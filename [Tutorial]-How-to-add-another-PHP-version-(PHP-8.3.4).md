...
Also, if you recieve an error message about "nghttp2_option_set_no_rfc9113_leading_and_trailing_ws_validation", [be sure to update Apache](https://github.com/leokhoa/laragon/discussions/484). It's as easy as updating PHP.